...
var bool = prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.bool,
    object = prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.object;
var propTypes = {
...
var Component = autobind_decorator__WEBPACK_IMPORTED_MODULE_1___default()(_class =
/*#__PURE__*/
  ...
  _createClass(Component, [{
    ...
    value: function handleMsg(msg) {
      ...
      var _this$props = this.props,
          comm_msg = _this$props.comm_msg,
          save = _this$props.save;
      var _msg$content$data = msg.content.data,
          method = _msg$content$data.method,
          _msg$content$data$pro = _msg$content$data.props,
          props = _msg$content$data$pro === void 0 ? {} : _msg$content$data$pro;
      ...
      if (method === "update") {
        ...
        this.setState({
          renderProps: _objectSpread({}, props, comm_msg.content.data)
        });
    ...
    value: function render() {
      var renderProps = this.state.renderProps,
          ...
          comm_msg = _this$props2.comm_msg,
          comm = _this$props2.comm,
          components = _this$props2.components;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, renderProps && comm_msg && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components[comm_msg.content.data.module], _objectSpread({
        comm: comm
      }, renderProps)));
    }
  }]);
...
function createOutputArea(cell, target) {
  ...
  if (!cell.react_output[target]) {
    cell.react_output[target] = new _output__WEBPACK_IMPORTED_MODULE_0__["default"](cell);
    ...
    var handle_kernel = function handle_kernel(Jupyter, kernel) {
      ...
      kernel.comm_manager.register_target(commTarget, function (comm, msg) {
        if (msg['msg_type'] === 'comm_open') {
          ...
          var component = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_component__WEBPACK_IMPORTED_MODULE_1__["default"], _objectSpread({}, componentParams, {
            comm: comm,
            comm_msg: msg
          }));
          ...
          if (!componentParams.element) {
            ...
            if (cell.react_output && cell.react_output[commTarget]) {
              react_dom__WEBPACK_IMPORTED_MODULE_3___default.a.render(component, cell.react_output[commTarget].subarea);
            }
          } else {
